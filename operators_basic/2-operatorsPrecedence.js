...
console.log(25-10-5); //result:10

//bellow, executing right-to-left for operator =
let x,y;
x = y = 25-10-5;//result:10
console.log(x,y); //result:

const averageAge = ageJonas + ageSarah / 2;
console.log(ageJonas, ageSarah, averageAge); //result: 46 19 55.5

//parentesis
const averageAge2 = ( ageJonas + ageSarah) / 2;
console.log(ageJonas, ageSarah, averageAge2); //result 46 19 32.5